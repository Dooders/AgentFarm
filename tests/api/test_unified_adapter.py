...
class TestUnifiedAdapter:
    ...
    def test_create_simulation_invalid_config(self, mock_config_manager_class, temp_workspace):
        ...
        # Mock the config manager instance
        mock_config_manager = Mock()
        mock_config_manager.convert_to_simulation_config.return_value = None
    ...
    def test_stop_simulation_success(self, temp_workspace):
        ...
        assert status.status == SimulationStatus.STOPPED
    ...
    def test_create_experiment_invalid_config(self, mock_config_manager_class, temp_workspace):
        ...
        with pytest.raises(ValueError, match="Invalid experiment base configuration"):
    ...
    def test_analyze_simulation_success(self, mock_analyzer_class, temp_workspace):
        ...
        db_path = session_path / "simulations" / simulation_id / "simulation.db"
    ...
    def test_subscribe_to_events_success(self, temp_workspace):
        ...
        subscription_id = adapter.subscribe_to_events(
            ["simulation_started", "simulation_completed"], simulation_id="sim-123"
        )
