...
class TestBackgroundTasks:
    ...
    def test_background_simulation_error(self, temp_workspace):
        ...
        with patch('farm.api.server.run_simulation') as mock_run_sim:
            ...
            with _active_simulations_lock:
                ...
                assert active_simulations[sim_id]["error_message"] == "Simulation failed"
    ...
    def test_background_simulation_logging(self, temp_workspace):
        ...
        with patch('farm.api.server.logger') as mock_logger, \
             patch('farm.api.server.run_simulation') as mock_run_sim:
