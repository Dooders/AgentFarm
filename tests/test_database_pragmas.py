...
from tests.utils.test_helpers import DatabaseTestHelper, assert_pragma_setting
...
class TestDatabasePragmas(unittest.TestCase):
    ...
    def test_memory_profile(self):
        ...
        assert_pragma_setting(pragmas, "synchronous", 1, int)  # NORMAL
        assert_pragma_setting(pragmas, "journal_mode", "MEMORY", str)
