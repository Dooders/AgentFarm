...
class TestSpatialComputations:
    ...
    def test_compute_location_hotspots_empty(self):
        ...
        result = compute_location_hotspots({
            'location_activity': pd.DataFrame()
        })
    ...
    def test_calculate_euclidean_distance(self):
        ...
        from farm.analysis.spatial.movement import calculate_euclidean_distance
...
class TestSpatialVisualization:
    ...
    def test_plot_spatial_density(self, mock_plt, tmp_path):
        ...
        # Should create plot if data available
        assert mock_plt.close.called or not mock_plt.subplots.called
...
class TestSpatialModule:
    ...
    def test_module_registration(self):
        ...
        assert spatial_module.description == "Analysis of spatial patterns, movement trajectories, location effects, and clustering"
...
class TestEdgeCases:
    ...
    def test_plot_trajectories_single_agent(self, tmp_path):
        ...
        with patch('farm.analysis.spatial.plot.plt'):
    ...
    def test_validator_with_invalid_data(self):
        ...
        with pytest.raises(DataValidationError):
            validator.validate({
                'agent_positions': "not a dataframe",
                'resource_positions': pd.DataFrame()
            })
