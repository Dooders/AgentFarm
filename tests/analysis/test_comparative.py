...
class TestComparativeVisualization:
    ...
    def test_plot_comparison_metrics(self, mock_plt, sample_comparative_data, tmp_path):
    ...
    @patch('farm.analysis.comparative.plot.plt')
    def test_plot_parameter_differences(self, mock_plt, sample_parameter_data, tmp_path):
    ...
    @patch('farm.analysis.comparative.plot.plt')
    def test_plot_performance_comparison(self, mock_plt, sample_comparative_data, tmp_path):
    ...
    @patch('farm.analysis.comparative.plot.plt')
    def test_plot_simulation_comparison(self, mock_plt, sample_comparative_data, tmp_path):
...
class TestEdgeCases:
    ...
    def test_plot_with_single_simulation(self, tmp_path):
        ...
        with patch('farm.analysis.comparative.plot.plt'):
