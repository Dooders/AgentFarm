...
class TestEndToEndWorkflow:
    ...
    def test_complete_workflow(self, config_service_mock, test_analysis_module, tmp_path):
    ...
    def test_workflow_with_caching(
        ...
        assert result2.execution_time <= time1
...
class TestErrorHandling:
    ...
    def test_missing_experiment_path_error(self, config_service_mock, minimal_module, tmp_path):
    ...
    def test_function_error_handling(self, config_service_mock, tmp_path):
        ...
        class ErrorModule(BaseAnalysisModule):
            ...
            def register_functions(self):
                ...
                self._functions = {
                    "failing_func": make_analysis_function(failing_func)
                }
                self._groups = {"all": list(self._functions.values())}
