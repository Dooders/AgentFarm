...
class TestDatabasePerformance(unittest.TestCase):
    ...
    def test_batch_agent_creation_performance(self):
        ...
        # Generate agent data
        agent_data_list = [
            self._generate_random_agent_data() for _ in range(self.num_agents)
        ]
    ...
    def test_configuration_performance(self):
        ...
        test_config = {
            ...
            "environment_params": {
                "temperature_range": [
                    -10,
                    40,
                ],  # Changed to list for JSON compatibility
        ...
        for _ in range(100):
            ...
            self.assertEqual(
                retrieved_config["simulation_params"]["world_size"], [1000, 1000]
            )
