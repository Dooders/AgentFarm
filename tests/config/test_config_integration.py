...
class TestConfigIntegration(unittest.TestCase):
    ...
    def test_orchestrator_performance_regression(self):
        ...
        # Allow a bit of headroom for slower CI and virtualized environments
        self.assertLess(avg_cached_time, 5.0, f"Cached load time too slow: {avg_cached_time:.3f}ms")
