...
class TestLearningExperienceLoggingIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.logger = DataLogger(
            ...
            config=DataLoggingConfig(buffer_size=10, commit_interval=60)
        )
    ...
    def test_learning_experiences_logged_to_database(self):
        ...
        self.assertEqual(first_row[2], "ppo")  # module_type
    ...
    def test_different_algorithm_types_logged(self):
        ...
        # All algorithm types should be logged
        for algo_type in algorithm_types:
            self.assertIn(algo_type, logged_types)
...
class TestLearningExperienceLoggingPerformance(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.logger = DataLogger(
            ...
            config=DataLoggingConfig(buffer_size=100, commit_interval=60)
        )
