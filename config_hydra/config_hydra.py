...
class HydraConfigManager:
    ...
    def __init__(
        ...
        logger.info(f"HydraConfigManager initialized for environment: {self.environment}, agent: {self.agent}")
    ...
    def set(self, key: str, value: Any) -> None:
        ...
        # Invalidate cached simulation config
    ...
    def validate_configuration(self) -> Dict[str, List[str]]:
        ...
        try:
            # Try to create SimulationConfig to validate
            ...
            ratio_sum = sum(config.agent_type_ratios.values())
...
def create_hydra_config_manager(
    config_dir: str = "config_hydra/conf",
    environment: Optional[str] = None,
    agent: Optional[str] = None,
    overrides: Optional[List[str]] = None
) -> HydraConfigManager:
    """Create a Hydra configuration manager with default settings.
    ...
    Returns:
        HydraConfigManager instance
    """
    return HydraConfigManager(
