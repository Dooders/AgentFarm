...
def create_research_template(name: str, description: str = "", tags: List[str] = None):
...
def main():
    parser = argparse.ArgumentParser(description="Create research project from template")
