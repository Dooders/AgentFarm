...
class MockDominanceComputer:
    ...
    def compute_dominance_switches(self, sim_session) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "avg_dominance_periods": {"system": 25.0, "independent": 15.0, "control": 10.0},
            "phase_switches": {"early": 2, "middle": 2, "late": 1},
            "transition_matrix": {
    ...
    def compute_dominance_switch_factors(self, df: pd.DataFrame) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "switches_by_dominant_type": {"system": 3.5, "independent": 4.2, "control": 2.8},
...
def create_mock_computer(
    ...
    def _population_dominance_with_tracking(session):
        mock._track_call("compute_population_dominance")
        return population_dominance

    def _survival_dominance_with_tracking(session):
        mock._track_call("compute_survival_dominance")
        return survival_dominance

    mock.compute_population_dominance = _population_dominance_with_tracking
    mock.compute_survival_dominance = _survival_dominance_with_tracking

    if comprehensive_dominance is not None:

        def _comprehensive_dominance_with_tracking(session):
            mock._track_call("compute_comprehensive_dominance")
            return comprehensive_dominance

        mock.compute_comprehensive_dominance = _comprehensive_dominance_with_tracking
...
def create_mock_data_provider(custom_data: Optional[Dict[str, Any]] = None) -> MockDominanceDataProvider:
    """
