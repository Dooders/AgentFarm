...
class CombatModule(BaseAnalysisModule):
    ...
    def register_functions(self) -> None:
        ...
        self._functions = {
            ...
            "analyze_agent_performance": make_analysis_function(analyze_agent_combat_performance),
            ...
            "plot_agent_performance": make_analysis_function(plot_agent_combat_performance),
        ...
        self._groups = {
            ...
            "analysis": [
                ...
                self._functions["analyze_agent_performance"],
            ...
            "plots": [
                ...
                self._functions["plot_agent_performance"],
