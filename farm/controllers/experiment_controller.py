...
class ExperimentController:
    ...
    def __init__(
        ...
        self.output_dir = output_dir or Path(self.project.project_path) / "experiments" / f"{name}_{self.timestamp}"
    ...
    def _run_iteration(
        ...
        try:
            ...
            if controller.current_step < num_steps:
                raise RuntimeError(f"Simulation stopped early at step {controller.current_step}")
    ...
    def analyze_results(self) -> None:
        ...
        try:
            ...
            compare_simulations(
                search_path=str(self.output_dir),
