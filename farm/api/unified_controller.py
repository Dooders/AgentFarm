...
class AgentFarmController:
    ...
    def __init__(self, workspace_path: Optional[str] = None):
        ...
        logger.info(f"Initialized AgentFarmController with workspace: {self.workspace_path}")
    ...
    def resume_simulation(self, session_id: str, simulation_id: str) -> SimulationStatus:
    ...
    def get_simulation_status(self, session_id: str, simulation_id: str) -> SimulationStatus:
    ...
    def get_simulation_results(self, session_id: str, simulation_id: str) -> SimulationResults:
    ...
    def get_experiment_status(self, session_id: str, experiment_id: str) -> ExperimentStatus:
    ...
    def get_experiment_results(self, session_id: str, experiment_id: str) -> ExperimentResults:
    ...
    def create_config_from_template(self, template_name: str, overrides: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        """
        config = self.config_manager.create_config_from_template(template_name, overrides)
        if not config:
    ...
    def analyze_simulation(self, session_id: str, simulation_id: str) -> AnalysisResults:
    ...
    def compare_simulations(self, session_id: str, simulation_ids: List[str]) -> ComparisonResults:
    ...
    def generate_visualization(self, session_id: str, simulation_id: str, viz_type: str) -> str:
