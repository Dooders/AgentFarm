...
class FeatureEngineer:
    ...
    def extract_features(self, agent: "BaseAgent", environment: "Environment") -> np.ndarray:
        features: List[float] = []
    ...
    def _extract_environmental_features(self, agent: "BaseAgent", environment: "Environment") -> List[float]:
        ...
        starvation_ratio = float(agent.starvation_threshold) / max(1.0, float(agent.max_starvation))

        return [resource_density, starvation_ratio]

    def _extract_social_features(self, agent: "BaseAgent", environment: "Environment") -> List[float]:
