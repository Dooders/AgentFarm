...
def create_clean_frame(ax, agents, resources, config, color_scheme):
    ...
    is_dark_bg = sum(int(color_scheme['background'].lstrip('#')[i:i+2], 16) for i in (0, 2, 4)) < 384
...
def main():
    ...
    selected_iterations = [
        249, 123, 110, 37, 225,  # First row
        71, 233, 61, 24, 19,     # Second row
        190, 11, 178, 36, 131,   # Third row
        42, 85, 156, 201, 95,    # Fourth row
        145, 167, 188, 205, 220  # Fifth row
    ]
