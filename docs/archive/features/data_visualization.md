...
### Documentation
- [Database Schema](../reference/data/database_schema.md) - Detailed schema documentation
- [Data API](../reference/data/data_api.md) - Data access patterns
- [Repositories](../reference/data/repositories.md) - Repository documentation
- [Metrics](../metrics.md) - Available metrics
- [Analysis modules](../reference/analysis/modules/README.md) - Analysis modules

### Examples
- [Usage examples](../guides/usage-examples.md) — visualization and analysis patterns
...
- **Examples**: See [Usage examples](../guides/usage-examples.md) and `farm/charts/`
