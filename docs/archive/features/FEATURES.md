...
**Quick example (directional):** extend **`IAgentBehavior`** / **`AgentComponent`** under `farm/core/agent/`, or subclass **`Environment`** in `farm/core/environment.py` if you need different world dynamics. See [Usage examples](../guides/usage-examples.md) and the agent package README patterns before copying large snippets.
...
- [User Guide](../guides/development-setup.md) — Config Explorer UI (`farm/editor`)
- [Developer Guide](../guides/development-setup.md) — Config Explorer / frontend dev
- [Contributing](../../CONTRIBUTING.md) — Python package and tests
- [API Reference](../reference/api-reference.md) — module reference
- [Usage examples](../guides/usage-examples.md) — tutorials and snippets
...
**Use Cases & Studies:**
- [Experiment write-ups](../research/experiments/)
...
- **📖 Documentation**: Start with the [User Guide](../guides/development-setup.md)
...
Or dive right in with the [First simulation guide](../../getting-started/first-simulation.md)!
