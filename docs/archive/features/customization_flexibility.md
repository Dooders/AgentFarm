...
### Documentation
- [Configuration System](../reference/config/configuration_guide.md) - Detailed configuration guide
- [Agent System](../concepts/agents-and-decisions.md) - Agent customization details
- [Action System](../concepts/actions.md) - Custom action development
- [Scenario Design](../generic_simulation_scenario_howto.md) - Complete scenario guide

### Examples
- [Usage Examples](../guides/usage-examples.md) - Practical tutorials
- [Experiment QuickStart](../../getting-started/experiments-quickstart.md) - Running experiments
- [Custom Scenarios](../research/experiments/) - Example scenarios

### API Reference
- [SimulationConfig](../reference/api-reference.md#simulationconfig) - Configuration API
- [Environment](../reference/api-reference.md#environment) - Environment API
- [BaseAgent](../reference/api-reference.md#baseagent) - Agent API
...
- **Examples**: See [Usage examples](../guides/usage-examples.md) and tests under `tests/`

---

**Ready to customize?** Start with the [Configuration System](../reference/config/configuration_guide.md) or explore our [Usage Examples](../guides/usage-examples.md) to see customization in action!
