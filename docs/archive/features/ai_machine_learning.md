...
> **Step-by-step runbook:** [`docs/guides/neural-recombination-runbook.md`](../guides/neural-recombination-runbook.md) — copy-paste commands, parameter tables, and tuning tips for reproducing the full pipeline.
...
### Documentation
- [Deep Q-Learning](../concepts/deep-q-learning.md) - Detailed DQN documentation
- [Decision Module](../../farm/core/decision/README.md) - Algorithm implementations
- [Analysis modules](../reference/analysis/modules/README.md) - ML-related analysis docs
...
- **[Neural Recombination Runbook](../guides/neural-recombination-runbook.md)** — step-by-step how-to with copy-paste commands, full parameter tables, and tuning tips ([AgentFarm#8](https://github.com/Dooders/AgentFarm/issues/8))
...
### Examples
- [Usage examples](../guides/usage-examples.md) — RL, training, and experiment patterns
...
- **Examples**: See [Usage examples](../guides/usage-examples.md) and `farm/research/`
