...
### Documentation
- [Spatial Indexing Details](../concepts/spatial/spatial_indexing.md) - Technical implementation
- [Verified tables (generated)](../../benchmarks/results/SPATIAL_BENCHMARK_VERIFIED.md) - Committed benchmark output
- [Configuration Guide](../reference/config/configuration_guide.md) - Spatial config options
