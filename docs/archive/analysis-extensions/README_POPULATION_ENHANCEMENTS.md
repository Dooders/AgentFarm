# Population Analysis Module - Enhancement Summary
...
6. **docs/guides/usage-examples.md** - 6 working examples
7. **docs/reference/analysis/modules/Population.md** - Tutorial for adding new analyses
...
| **How to extend** | `docs/reference/analysis/modules/Population.md` |
...
3. Follow `docs/reference/analysis/modules/Population.md` tutorial
