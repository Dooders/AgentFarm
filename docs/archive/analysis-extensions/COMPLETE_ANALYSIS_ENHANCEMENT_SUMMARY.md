...
7. **docs/guides/usage-examples.md** - Working examples
8. **docs/reference/analysis/modules/Population.md** - Extension tutorial
...
└── Examples & Tutorials
    ...
    └── docs/reference/analysis/modules/Population.md
```
...
#### 2. Explore Extensions (15 minutes)
```bash
# Read master index
...
# Study example
See docs/reference/analysis/modules/Population.md
```
...
- **docs/guides/usage-examples.md** - Working examples
- **docs/reference/analysis/modules/Population.md** - Implementation tutorial

---

## 🎯 Recommended Path

### Path 1: Quick Value (1 hour)
...
1. Study tutorial: `docs/reference/analysis/modules/Population.md`
