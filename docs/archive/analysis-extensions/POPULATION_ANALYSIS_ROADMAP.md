...
| `docs/guides/usage-examples.md` | Working code examples | All Users |
| `docs/reference/analysis/modules/Population.md` | Extension tutorial | Developers |
...
→ Tutorial: `docs/reference/analysis/modules/Population.md`

#### **See working examples**
→ Run: `pytest tests/`. See `docs/guides/usage-examples.md` for working examples.
...
2. **Run the examples** (15 minutes)
   - Follow the examples in `docs/guides/usage-examples.md`
...
3. **Extend with new analyses** (4-8 hours per analysis)
   ...
   - Follow tutorial in `docs/reference/analysis/modules/Population.md`
...
2. Follow the examples in: `docs/guides/usage-examples.md`
...
2. Extend: Follow `docs/reference/analysis/modules/Population.md`
...
See `docs/reference/analysis/modules/Population.md` for complete tutorial.
