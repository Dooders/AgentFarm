...
The shareable explainer below walks through all four ideas — what an agent is, what the environment is, what agents do, and an example on a grid. The file to send is [intro-explainer.mp4](../assets/intro-explainer.mp4) (about 95 seconds, 720p).
