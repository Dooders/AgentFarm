...
## Compact threshold grid (v2, 4 seeds × 550 steps)

Same four arms crossed with four worlds. Courtship gate, bonding cost, accumulated strength, accidental divorce, extraction logging.
