...
- **Start here (no technical background):** [A gentle introduction](docs/getting-started/a-gentle-introduction.md) · shareable explainer: [intro-explainer.mp4](docs/assets/intro-explainer.mp4)
